        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              disabled={unlocking}
              className="flex-1 min-w-[8rem] py-3 rounded-xl bg-amber-700 hover:bg-amber-600 disabled:opacity-50 text-white text-xs font-black transition-all active:scale-[0.98]"
            >
              {unlocking ? "처리 중…" : "토큰으로 잠금 해제"}
            </button>
            <Link
              href="/shop"
              className="flex-1 min-w-[8rem] py-3 rounded-xl border border-violet-500/40 bg-violet-500/10 text-violet-200 text-xs font-black text-center leading-none flex items-center justify-center hover:bg-violet-500/20 transition-colors"
            >
              토큰 충전
            </Link>
          </div>
