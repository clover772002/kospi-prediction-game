        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              disabled={unlocking}
              className="flex-1 min-w-[8rem] py-3 rounded-xl bg-emerald-700 hover:bg-emerald-600 disabled:opacity-50 text-white text-xs font-black transition-all active:scale-[0.98]"
            >
