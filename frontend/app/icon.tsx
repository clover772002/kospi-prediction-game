...
export default function Icon() {
  ...
  const L_CX    = L_X + Math.round(BTN_W / 2);  // 53
  const R_CX    = R_X + Math.round(BTN_W / 2);  // 131
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ color: bg, fontSize: 21, fontWeight: 900, letterSpacing: 5, fontFamily: "sans-serif" }}>
            KOSPI
          </div>
        </div>
