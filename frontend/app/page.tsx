      ...
      <div className="w-full mt-12">
        ...
        <div className="space-y-3">
          {[
            ...
            {
              q: "고수랑 어떻게 소통하나요?",
              a: "시작 시 100토큰이 주어지고, 고수 탭은 보유 토큰이 210개 이상일 때 열립니다(예측 참여·적중을 약 3번 정도 쌓은 수준). 대시보드의 「최고 고수에게 질문 보내기」에서도 같은 화면으로 갈 수 있어요. 질문은 지금까지 기준 최고 고수 1명에게만 보낼 수 있고, 1통당 25토큰이 차감되며 고수가 팁을 수락할 때 전달됩니다. 고수의 답장에는 토큰이 들지 않아요.",
            },
            {
              q: "예측 결과가 조작될 수 있나요?",
