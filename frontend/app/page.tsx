        ...
        <div className="space-y-2">
          {[
            ...
            },
            {
              ...
              a: "로그인 후 대시보드에서 '텔레그램 연동' 버튼을 누르면 봇 링크가 나와요. 링크를 클릭하면 텔레그램이 열리고, 시작 버튼만 누르면 연동 완료입니다. 1분이면 끝나요.",
            },
            {
              q: "설문이 안 왔어요 / 봇이 메시지를 안 보내요",
              a: "① 대시보드에서 텔레그램 연동이 완료된 상태인지 확인해주세요. ② 텔레그램 앱에서 봇을 차단했는지 확인해주세요. ③ 설문은 평일 08:50에만 발송됩니다 (주말·공휴일 제외). 그래도 안 오면 forsmartonly@gmail.com으로 문의해 주세요.",
            },
            {
              q: "예측 결과가 조작될 수 있나요?",
              a: "장 마감 후 코스피·코스닥 등락은 외부 금융 데이터(yfinance)에서 자동으로 가져옵니다. 운영자가 임의로 결과를 바꿀 수 없는 구조예요.",
            },
            {
              q: "고수 가중예측은 언제부터 신뢰할 수 있나요?",
              a: "참여자가 많고 각 유저의 누적 데이터가 쌓일수록 정확해집니다. 초기엔 참고 수준으로 보시고, 데이터가 쌓이면서 단순 다수결과의 차이가 의미 있어지기 시작해요.",
            },
          ].map((item, i) => (
