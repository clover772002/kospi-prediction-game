        ...
        <div className="space-y-2">
          {[
            ...
            },
            {
              ...
              a: "참여자가 많고 누적 데이터가 쌓일수록 신뢰도가 올라갑니다. 초기엔 참고 수준으로 보시고, 시간이 지나면서 단순 다수결과의 차이가 얼마나 유의미한지 직접 추적해보세요.",
            },
            {
              q: "예측 결과가 조작될 수 있나요?",
            ...
            {
              q: "개인정보가 수집되나요?",
              a: "소셜 로그인 시 이름·이메일·프로필 사진이 저장됩니다. 채팅 내용·연락처·위치는 수집하지 않아요. 자세한 내용은 하단 개인정보처리방침을 확인해 주세요.",
            },
            {
              q: "텔레그램이 꼭 있어야 하나요?",
