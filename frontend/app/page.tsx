      ...
      <div className="w-full mt-12">
        ...
        <div className="space-y-3">
          {[
            ...
            {
              q: "고수랑 어떻게 소통하나요?",
              a: "로그인 후 보유 토큰이 200개 이상이면 하단 「고수」 탭이 열립니다. 대시보드의 「순위권 고수에게 질문 보내기」에서도 같은 화면으로 갈 수 있어요. 질문 1통당 25토큰이 차감되고, 고수가 해당 팁을 수락할 때 전달됩니다(수락 전까지는 에스크로). 고수의 답장에는 토큰이 들지 않아요.",
            },
            {
              q: "예측 결과가 조작될 수 있나요?",
