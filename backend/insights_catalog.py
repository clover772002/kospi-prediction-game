...
INSIGHT_PRODUCTS = {
    ...
    "rolling_crowd_summary": {
        "title": "고수의 7일간 적중률",
        "price_tokens": 140,
        "description": "선택한 날을 끝으로 최근 거래일 7일 구간에서, 무리 규격 ‘고수층’ 설문 참가자의 일자별 코스피 방향 적중 비율을 시계열로 봅니다. 확정 결과가 없는 날은 비워 둘 수 있습니다.",
    },
    "time_slice_accuracy": {
    ...
    "expert_vote_time_profile": {
        "title": "오늘 정답자들의 투표시간 분포",
        "price_tokens": 100,
        "description": "해당 거래일 코스피 결과가 확정된 뒤에만 제공됩니다. 그날 맞히고(responded_at 기록 포함) 사람들만 모아 시간대 버킷 비율을 봅니다.",
    },
    "novice_vote_time_profile": {
        "title": "오늘 오답자들의 투표시간 분포",
        "price_tokens": 90,
        "description": "해당 거래일 코스피 결과가 확정된 뒤에만 제공됩니다. 그날 틀린 사람 중 제출 시각이 기록된 응답만 모아 시간대 분포를 봅니다.",
    },
    "expert_leader_pick": {
        "title": "오늘의 고수 픽",
        "price_tokens": 95,
        "description": (
            "그날 무리 규격의 고수층 가운데 누적 적중 1순위(동률 시 id순) 한 명을 고르고, "
