...
INSIGHT_PRODUCTS = {
    ...
    "rolling_crowd_summary": {
        "title": "고수의 7일간 적중률",
        "price_tokens": 140,
        "description": "선택한 날을 끝으로 최근 거래일 7일 구간에서, 베이지안 보정·최근 활동 규격을 통과한 최고 고수 1명이 그날 설문에 참여한 날의 적중 여부(0%·100%)를 봅니다.",
    },
    "time_slice_accuracy": {
        "title": "최고 고수 최근 7일 응답 시간",
        "price_tokens": 130,
        "description": "예측 횟수·최근 활동·베이지안 보정 적중 규격을 통과한 최고 고수 1명의 최근 7거래일 제출 시각만 시간대 버킷으로 봅니다. 시각 미기록 응답은 제외됩니다.",
    },
    ...
    "expert_leader_pick": {
        ...
        "price_tokens": 95,
        "description": (
            "베이지안 보정·최근 활동 규격을 통과한 최고 고수 1명이 그날 설문에 참여했을 때, "
            "방향·확신도(게이지)를 초성 이름과 함께 표시합니다. 매매 조언이 아닙니다."
        ),
    },
    "novice_leader_pick": {
        "title": "오늘의 하수 픽",
